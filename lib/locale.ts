...
const translations: Record<string, string> = {
  ...
  "Sự tận tâm trong từng chi tiết.": "Genuine care in every detail.",
  "SK Boutique Hotel được kiến tạo để mang lại một không gian lưu trú ấm cúng, tinh tế và riêng tư tuyệt đối cho khách hàng.": "SK Boutique Hotel is crafted to offer a cozy, refined, and completely private sanctuary for our guests.",
  "Không gian lưu giữ nét kiến trúc hài hòa cùng dòng thời gian.": "A space preserving architectural harmony across time.",
  "Hành trình kiến tạo không gian nghỉ dưỡng boutique tại Phú Quốc.": "Our journey of crafting boutique stay experiences in Phu Quoc.",
  "Sự hài lòng từ những vị khách trân quý nét đẹp tĩnh lặng.": "The satisfaction of guests who appreciate quiet beauty.",
  "Trải nghiệm lưu trú bằng mọi giác quan.": "A stay experience that engages every sense.",
  "Tại SK, chúng tôi tin rằng một kỳ nghỉ trọn vẹn được tạo nên từ sự thấu hiểu và chăm chút chu đáo nhất.": "At SK, we believe a complete stay is defined by understanding and thoughtful care.",
  "Chúng tôi trân trọng từng khoảnh khắc bình yên và sự riêng tư của bạn.": "We cherish every moment of your peace and privacy.",
  "Không gian nghỉ ngơi ấm cúng mang lại cảm giác thân thuộc như trở về nhà.": "Cozy guest rooms that bring a warm feeling of returning home.",
  "Thiết kế hướng tới tự nhiên, tận dụng tối đa ánh sáng và khí trời bản địa.": "A nature-inspired design maximizing natural light and local air.",
  "Sự tỉ mỉ được thể hiện qua từng vật dụng và dịch vụ chăm sóc khách hàng.": "Meticulous care reflected in every amenity and hospitality service.",
  "Từng góc nhỏ tại SK đều mang câu chuyện về lòng hiếu khách.": "Every small corner at SK tells a story of hospitality.",
  "Sự tinh tế trong từng điểm chạm.": "Refinement in every touchpoint.",
  "Chúng tôi theo đuổi những giá trị nguyên bản để mang lại trải nghiệm nghỉ dưỡng đích thực.": "We pursue original values to bring an authentic stay experience.",
  "Tinh tế: Mọi chi tiết thiết kế đều có lý do tồn tại, lược bỏ sự rườm rà.": "Refinement: Every design detail has a purpose, free from unnecessary clutter.",
  "Riêng tư: Không gian được sắp đặt mang lại sự tự do và kín đáo tối đa.": "Privacy: Spaces arranged to offer maximum freedom and discretion.",
  "Chân thành: Lòng hiếu khách mộc mạc và sự hỗ trợ tận tâm trong suốt kỳ nghỉ.": "Sincerity: Warm hospitality and dedicated support throughout your stay.",
  "Màu sắc tự nhiên giao hòa cùng vật liệu mộc và ánh nắng bản địa.": "Natural colors blending with raw materials and local sunlight.",
